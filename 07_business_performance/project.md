...
Размер трат на **FaceBoom** одинаков за весь период, но оукпаемости тоже нет. Стоит снизить размер инвестиций в данном канале, до получения окупаемости или пересмотреть рекламную компанию.    
...
Графики сливаются в один. Вероятно, пользователи из канала **TipTop** (с большой аудиторией и самого дорогово) распределены одинаково между устройствами.
```
# рассчитаем среднее среди устройств в каналн TopTop
